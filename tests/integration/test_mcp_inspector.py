...
class MCPInspectorClient:
        ...
        try:
            ...
            while time.time() - start_time < timeout:
                try:
                    ...
                    url_match = re.search(r'http://localhost:(\d+)/\?MCP_PROXY_AUTH_TOKEN=([a-f0-9]+)', line)
                    if url_match:
    ...
    def test_connection(self) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                print(f"✅ Connected to MCP Inspector")
                return True
            else:
    ...
    def send_mcp_message(self, connection_id: str, message: Dict[str, Any]) -> Optional[Dict[str, Any]]:
...
def main():
    ...
    try:
        ...
        repo_config = {
            "transportType": "stdio",
            "command": "poetry",
            "args": ["run", "python", "-m", "mcp_local_repo_analyzer.main", "--work-dir", "./mcp_local_repo_analyzer"],
            "env": {}
        }
        ...
        print(f"✅ Connection created, testing MCP communication...")
